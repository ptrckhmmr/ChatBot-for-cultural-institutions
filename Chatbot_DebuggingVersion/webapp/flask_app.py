...
It also incorporates the trained models of the folder app and other mindmeld dependencies, such as the nlp unit.
"""
...
def process_form():
    """
    The input form of the html file is processed here. Furthermore, the chat is logged.

    Returns:
        The chatbot output and the intent used for the output are jsonified
    """
...
def corrected_question():
    ...
    """
    This function logs automatically the corrected questions for the intent 'unsupported'

    Returns:
        The chatbot output and a message that the adjustment was done correctly are jsonified
    """
...
def false_corrected_question():
    """
    This function logs automatically the falsely corrected questions for the intent 'unsupported'

    Returns:
        A message that the adjustment was done incorrectly is jsonified
    """
...
def intent_learning_improve():
    """
    This function reports the false modelled intents

    Returns:
        A message that the intent was modelled falsely is jsonified.
    """
...
def intent_learning_alright():
    """
    This function reports the correctly modelled intents

    Returns:
        A message that the intent was modelled correctly is jsonified.
    """
...
def get_artists():
    """
        This function sends 10 artists to the frontend

        Returns:
            A list of 10 artists is jsonified.
        """
...
def get_exhibitions():
    """
    This function sends 10 exhibtions to the frontend

    Returns:
        A list of 10 exibitions is jsonified.
    """
...
def tabelle_umwandeln():
    """
    This function creates a table of artists based on the output of the chatbot

    Returns:
        The exhibition and a list of artist is jsonified.
    """
